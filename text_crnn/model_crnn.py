    ...
    def __init__(self, nc, nclass, nh):
        ...
        def conv_relu(i, batch_norm=False):
            ...
            if batch_norm:
                ...
                cnn.add_module('batchnorm{0}'.format(i), nn.BatchNorm2d(num_features=nout))
        ...
        rnn.add_module('{0}'.format(0), BidirectionalLSTM(512, nh, nh))
        rnn.add_module('{0}'.format(1), BidirectionalLSTM(nh, nh, nclass))
        self.rnn = rnn
